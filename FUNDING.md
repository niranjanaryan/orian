...
Support the development of **Orian** and the distributed Elixir stack.
...
- **BLAKE3 / S3 / S5 storage** — content-addressed storage, CID, integrity verification
- **Zig NIF maintenance** — hash64, BLAKE3, XXH3
- **Storage benchmarking** — HTTP/3 paths, backend interop
